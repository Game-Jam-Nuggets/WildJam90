...
@onready var control_guide: ControlGuide = $ControlGuide
...
func _on_level_1_pressed() -> void:
	...
	control_guide.start_transition(Level_Info.LEVEL_ID.LEVEL_1)

func _on_level_2_pressed() -> void:
	AudioManager.play_sfx(level_select_sound)
	control_guide.start_transition(Level_Info.LEVEL_ID.LEVEL_2)
